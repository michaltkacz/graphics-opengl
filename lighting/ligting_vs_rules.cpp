...
void keys(unsigned char key, int x, int y)
{
	...
	else if (key == '3') glEnable(GL_LIGHT1);
	else if (key == '4') glDisable(GL_LIGHT1);
	else if (key == '5') glEnable(GL_LIGHT2);
	else if (key == '6') glDisable(GL_LIGHT2);
	else if (key == '7') glEnable(GL_LIGHT3);
	else if (key == '8') glDisable(GL_LIGHT3);
	else if (key == '9') glEnable(GL_LIGHT4);
	else if (key == '0') glDisable(GL_LIGHT4);
...
void move_light1()
{
	...
	light1_position[0] = light1_radius * cosf(light1_azimuth_angle * DEG_TO_RAD) * cosf(light1_inclination_angle * DEG_TO_RAD);
	light1_position[1] = light1_radius * sinf(light1_inclination_angle * DEG_TO_RAD);
	light1_position[2] = light1_radius * sinf(light1_azimuth_angle * DEG_TO_RAD) * cosf(light1_inclination_angle * DEG_TO_RAD);
...
void move_light2()
{
	...
	light2_position[0] = light2_radius * cosf(light2_azimuth_angle * DEG_TO_RAD) * cosf(light2_inclination_angle * DEG_TO_RAD);
	light2_position[1] = light2_radius * sinf(light2_inclination_angle * DEG_TO_RAD);
	light2_position[2] = light2_radius * sinf(light2_azimuth_angle * DEG_TO_RAD) * cosf(light2_inclination_angle * DEG_TO_RAD);
...
void move_light3()
{
	...
	light3_position[0] = light3_radius * cosf(light3_azimuth_angle * DEG_TO_RAD) * cosf(light3_inclination_angle * DEG_TO_RAD);
	light3_position[1] = light3_radius * sinf(light3_inclination_angle * DEG_TO_RAD);
	light3_position[2] = light3_radius * sinf(light3_azimuth_angle * DEG_TO_RAD) * cosf(light3_inclination_angle * DEG_TO_RAD);
